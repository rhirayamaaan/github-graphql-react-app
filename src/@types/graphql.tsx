...
export type UsersFragment = (
  { __typename?: 'User' }
  & Pick<User, 'id' | 'bio' | 'name' | 'url' | 'avatarUrl' | 'login'>
);
 ...
 * });
 */
export function useTopQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<TopQuery, TopQueryVariables>) {
        return ApolloReactHooks.useQuery<TopQuery, TopQueryVariables>(TopDocument, baseOptions);
      }
export function useTopLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<TopQuery, TopQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<TopQuery, TopQueryVariables>(TopDocument, baseOptions);
        }
...
export type TopQueryResult = ApolloReactCommon.QueryResult<TopQuery, TopQueryVariables>;